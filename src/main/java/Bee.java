...
public class Bee extends Thread {
    ...
    private ArrayList<Bee> BEE;
    
    public Bee(JLabel g,ArrayList<Food> F,ArrayList<Bee> A,ArrayList<MyImageIcon> M,Silo S,ArrayList<MySoundEffect> s){
        gamepane = g;
        FOOD = F;
        BEE = A;
        Image = M;
        ...
        AnimationThread = new Thread(){
            public void run(){
                ...
                while(Num_Animation==1){
                    if(i%8==0)This_Label.setIcon(Image.get(0));
                    if(i%8==1)This_Label.setIcon(Image.get(1));
                    if(i%8==2)This_Label.setIcon(Image.get(2));
                    if(i%8==3)This_Label.setIcon(Image.get(3));
                    if(i%8==4)This_Label.setIcon(Image.get(4));
                    if(i%8==5)This_Label.setIcon(Image.get(3));
                    if(i%8==6)This_Label.setIcon(Image.get(2));
                    if(i%8==7)This_Label.setIcon(Image.get(1));
                    i++;
                    try { Thread.sleep(50); } 
                    catch (InterruptedException e) { e.printStackTrace(); }
                }
                while(Num_Animation==2){
                    if(i%8==0)This_Label.setIcon(Image.get(5));
                    if(i%8==1)This_Label.setIcon(Image.get(6));
                    if(i%8==2)This_Label.setIcon(Image.get(7));
                    if(i%8==3)This_Label.setIcon(Image.get(8));
                    if(i%8==4)This_Label.setIcon(Image.get(9));
                    if(i%8==5)This_Label.setIcon(Image.get(8));
                    if(i%8==6)This_Label.setIcon(Image.get(7));
                    if(i%8==7)This_Label.setIcon(Image.get(6));
                    i++;
                    try { Thread.sleep(50); } 
                    catch (InterruptedException e) { e.printStackTrace(); }
                }
    ...
    public void drop(){
        dropLate--;
        if(dropLate==0){
            new Honeycomb(gamepane,CurX+50,CurY+50,Image.get(13),Silo,Sound);
